...
@auth
    ...
    @guest
        ...
        <head>
            ...
            <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Montserrat:400,700|Playfair+Display:400,700|Roboto:400,700|Lato:400,700|Pacifico&display=swap">
            ...
            <style>
                html{
                    background-image: url("/public/HomeImages/ngorongoro conservation area.png");
                ...
                .pagination {
                    font-size: 0.8rem; /* Make pagination links huge */
                    float: right;
                ...
                .gallery-item {
                    flex: 1 1 calc(50% - 20px); /* Adjust width and margin as needed */
                    margin: 10px; /* Adjust margin as needed */
                    position: relative;
                    overflow: hidden;
                }
                ...
                .map-container {
                    ...
                    margin-top: 20px; /* Add margin or padding as needed */
