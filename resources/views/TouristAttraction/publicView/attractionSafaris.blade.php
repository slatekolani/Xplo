...
<div class="row">
    <div class="col-md-12">
        <div class="row">
            ...
            @empty
                <div class="col-md-12">
                    <p style="padding-left: 20px">Whoops! It seems that <span style="color:dodgerblue">{{$localTourPackage->attraction_name}}</span> does not have any active local tour packages posted.</p>
                </div>
            @endforelse
        </div>
    </div>
