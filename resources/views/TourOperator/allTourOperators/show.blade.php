            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @forelse($tourOperators as $tourOperator)
                        <div class="card h-100 border-primary card-with-gradient">
                            <div class="row">
                                ...
                                <div class="col-md-6" style="margin-top: 20px">
                                    ...
                                    <p><b>Year established</b>:
                                        {{ date('jS M Y', strtotime($tourOperator->established_date)) }}</p>
                                    <p><b>Years of experience</b>: {{ $tourOperator->TourCompanyYearsOfExperienceLabel }}
                                        years</p>
                                    ...
                                    <p><b>Offering custom Safari's?</b>
                                        ...
                                        <span>Yes, <span style="color:dodgerblue">{{$tourOperator->company_name}}</span> offers custom safari's</span>
                                        @elseif($tourOperator->agreeCustomBooking =="No")
                                        <span>No, <span style="color:dodgerblue">{{$tourOperator->company_name}}</span> does not offer custom safari's</span>
                                            ...
                                            <div class="row">
                                                <div class="text-center">
                                                    <a href="{{ route('customTourBookings.create', $tourOperator->uuid) }}"
                                                        class="btn btn-primary btn-sm" style="margin-left: 10px">Request
                                                        custom tour &blacktriangleright;</a>
                                                </div>
                                            </div>
                                        @else
                                            <div class="row">
                        ...
                        <div class="modal fade" id="tourCompanyWebsiteModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <iframe id="websiteIframe" width="100%" height="600"
                    ...
                    @empty
                        <p>No available tour operators are currently operating around the region. However, if you plan to
                            travel to this area, we will do our best to recommend one for you. Please reach out to us via
                            WhatsApp or email. We value your privacy and assure you that we will not share your information
                            with any third-party software or elsewhere</p>
                    @endforelse
                </div>
