@extends('layouts.main', ['title' => __("Update company"), 'header' => __("Update company")])

@include('includes.validate_assets')
@section('content')

    {{ Form::model($tourOperator,['enctype="multipart/form-data"','route' => ['tourOperator.update', $tourOperator->uuid], 'method'=>'put','autocomplete' => 'off',
'id' => 'update','class' => 'form-horizontal  needs-validation', 'novalidate']) }}
    {{ Form::hidden('user_id', $tourOperator->id, []) }}
@csrf
    <section>
                            ...
                            <div class="row">
                                <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('company_name', $tourOperator->company_name, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'company_name', 'required']) }}
                                ...
                                <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::email('email_address', $tourOperator->email_address, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'email_address', 'required']) }}
                                ...
                                <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::tel('phone_number', $tourOperator->phone_number, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'phone_number', 'required']) }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::number('postal_code',$tourOperator->postal_code, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'postal_code','maxLength'=>'10', 'required']) }}
                                ...
                                <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::number('tin_number',$tourOperator->tin_number, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'tin_number','maxLength'=>'8', 'required']) }}
                                ...
                                <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('physical_location',$tourOperator->physical_location, ['class' => 'form-control', 'autocomplete' => 'off','placeholder'=>'NSSF Kaloleni Plaza,Ground Floor', 'id' => 'physical_location','maxLength'=>'50', 'required']) }}
                                ...
                                <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::date('established_date',$tourOperator->established_date, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'established_date', 'required']) }}
                                ...
                                <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::number('total_employees',$tourOperator->total_employees, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'total_employees', 'required']) }}
                                    ...
                                    <div class="row">
                                        <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                {{ Form::select('company_nation',$nations,$tourOperator->company_nation, ['class' => 'form-control select2', 'autocomplete' => 'off', 'id' => 'company_nation', 'required']) }}
                                        ...
                                        <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <a href="{{asset('public/TourOperatorsLogos/'.$tourOperator->company_logo)}}" target="_blank">Previous logo</a>
                                                {{ Form::file('company_logo',null, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'company_logo']) }}
                                        ...
                                        <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <a href="{{asset('public/CompaniesTeamImage/'.$tourOperator->company_team_image)}}" target="_blank">Previous image</a>
                                                {{ Form::file('company_team_image',null, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'company_team_image']) }}
                                    ...
                                    <div class="row">
                                        <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <a href="{{asset('public/VerificationCertificates/'.$tourOperator->verification_certificate)}}" target="_blank">Previous</a>
                                                {{ Form::file('verification_certificate',null, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'verification_certificate']) }}
                                        ...
                                        <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <a href="{{asset('public/membershipCertificates/'.$tourOperator->tato_membership_certificate)}}" target="_blank"> Previous</a>
                                                {{ Form::file('tato_membership_certificate',null, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'tato_membership_certificate']) }}
                                        ...
                                        <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <a href="{{asset('public/companyTermsAndConditions/'.$tourOperator->terms_and_conditions)}}" target="_blank">Previous terms and conditions</a>
                                                {{ Form::file('terms_and_conditions',null, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'terms_and_conditions']) }}
                                    ...
                                    <div class="row">
                                        <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                {{ Form::url('website_url', $tourOperator->website_url, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'website_url', 'required']) }}
                                        ...
                                        <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                {{ Form::url('instagram_url',$tourOperator->instagram_url, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'instagram_url', 'required']) }}
                                        ...
                                        <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                {{ Form::url('whatsapp_url',$tourOperator->whatsapp_url, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'whatsapp_url', 'required']) }}
                                    ...
                                    <div class="row">
                                        <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                {{ Form::url('gps_url',$tourOperator->gps_url, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'gps_url', 'required']) }}
                                        ...
                                        <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                {{ Form::text('support_time_range',$tourOperator->support_time_range, ['class' => 'form-control', 'autocomplete' => 'off', 'placeholder'=>'24 hours after request received','id' => 'support_time_range', 'required']) }}
                                        ...
                                        <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                {{ Form::select('safari_area_preferences[]',$touristAttractions,$tourOperatorSafariPreferences, ['class' => 'form-control select2','multiple', 'autocomplete' => 'off', 'id' => 'safari_area_preferences', 'required']) }}
                                    ...
                                    <div class="row">
                                        <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                {{ Form::select('regions_of_operation[]',$regionsOfOperations,$tourOperatorRegionsOfOperation, ['class' => 'form-control select2','multiple', 'autocomplete' => 'off', 'id' => 'regions_of_operation', 'required']) }}
                                        ...
                                        <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                {{ Form::select('insurance_types_offered[]',$tourInsuranceTypes,$tourOperatorInsurances, ['class' => 'form-control select2','multiple', 'autocomplete' => 'off', 'id' => 'insurance_types_offered', 'required']) }}
