@extends('layouts.main', ['title' => __("Tour Company"), 'header' => __('Tour Company')])
    ...
    <div class="row">
        <div class="col-md-12" >
            <div class="pull-left" style="margin-bottom: 10px" >
                <a class ='btn btn-primary btn-sm'  href="{{route('tourOperator.edit',$tourOperator->uuid)}}">Edit information</a>
            </div>
        </div>
        <div class="col-md-12">
            <div class="row">
