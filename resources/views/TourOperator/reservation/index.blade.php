@extends('layouts.main', ['title' => trans('Reservations - ' . $tourOperator->company_name), 'header' => trans('Reservations - ' . $tourOperator->company_name)])
    ...
    <div class="row" style="overflow-x: scroll">
        ...
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:150%;background-color:rgba(255,255,255,0.85)">
                ...
                @include('TourOperator.reservation.get_tour_company_reservations')
            </section>
        </div>
