                                ...
                                <div class="row">
                                    @forelse($localTourPackages as $localTourPackage)
                                        ...
                                        @elseif(!$noLocalTourPackageAttractions)
                                            <div class="col-md-12">
                                                <p style="padding-left: 20px;">No local safaris are currently posted about
                                                    this attraction. However, explore the tour operator section to discover
                                                    all the tour operators around this attraction.</p>
                                            </div>
                                            @php
                                    ...
                                    @empty
                                        <div class="col-md-12">
                                            <p style="padding-left: 20px;">No local safaris are currently posted about this
                                                attraction. However, explore the tour operator section to discover all the
                                                tour operators around this attraction.</p>
                                        </div>
                                    @endforelse
                                </div>
        ...
        <div class="row" style="padding-top: 5px">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="col-md-12">
                            <p class="card-title" style="font-size: 14px;font-weight: bold">Reservations Included in
                                Posted Safaris</p>
                            <div class="row">
                                <?php
                                $reservationCount = 0;
                            ...
                            @empty
                                <div class="col-md-12">
                                    <p style="padding-left: 20px">Whoops! No Reservation included yet from the tour
                                        packages.</p>
                                </div>
                            @endforelse
                        ...
                        <div class="row" style="margin-top: 30px">
                            <div class="col-md-12" style="margin-top: 20px">
                                <p class="card-title" style="font-size: 14px;font-weight: bold">Reviews - <span
                                        class="badge badge-primary">{{ $totalLocalTouristReviews }}</span></p>
                                @forelse($localTouristReviews as $localTouristReview)
                                    <img width="24" height="24"
                                        src="https://img.icons8.com/material/24/user--v1.png" alt="user--v1" />
                                    <span
                                        style="font-weight: bold">{{ $localTouristReview->localTourPackageBooking->tourist_name }}</span>
                                    <div
                                        style="border: 2px solid gainsboro;padding: 10px 10px 10px 10px;text-align: center">
                                        <span style="font-weight: bold">"Travelled to
                                            {{ $localTouristReview->localTourPackage->touristicAttraction->attraction_name }}"</span><br>
                        ...
                        @empty
                            <img width="24" height="24" src="https://img.icons8.com/material/24/user--v1.png"
                                alt="user--v1" />
                            ...
                            <div style="border: 1px solid gainsboro;padding: 10px 10px 10px 10px;text-align: center">
                                <span>This tour operator has not yet received any reviews. However, we are confident in
                                    the quality of their services, and you can always choose their company for your
                                    trip. Once you are finished, a link will be sent to you automatically or manually at
                                    some points. Please support this tour operator by being the first to leave a review.
                                    We appreciate both positive and negative feedback; just share your honest
                                    opinion</span>
                            </div>
                            <div class="d-flex justify-content-center">
                                <a href="#" class="btn btn-primary btn-sm text-center"
                                    style="margin-top: 20px;">Contact Support Team
                                    &blacktriangleright;</a>
                            </div>
                            @endforelse
                        </div>
