@extends('layouts.main', ['title' => trans('Unapproved Local Tour Bookings'), 'header' => trans('Unapproved Local Tour Bookings')])
    ...
    <div class="row" style="overflow-x: scroll">
        ...
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:250%;background-color:rgba(255,255,255,0.85)">
                ...
                @include('TourOperator.TourPackages.localTourPackages.bookings.unapprovedBookings.get_unapproved_bookings')
            </section>
        </div>
