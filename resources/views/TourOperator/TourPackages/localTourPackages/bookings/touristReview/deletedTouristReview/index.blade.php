@extends('layouts.main', ['title' =>'Deleted Local Tourist Review ' . $localTourBooking->tourist_name, 'header' => __('Deleted Local Tourist Review ' . $localTourBooking->tourist_name)])
    ...
    <div class="row" style="overflow-x: scroll">
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:120%;background-color:rgba(255,255,255,0.85)">
                ...
                @include('TourOperator.TourPackages.localTourPackages.bookings.touristReview.deletedTouristReview.get_deleted_tourist_review')
            </section>
        </div>
