@extends('layouts.main', ['title' =>'Approved Local Tourist Review ' . $localTourBooking->tourist_name, 'header' => __('Approved Local Tourist Review ' . $localTourBooking->tourist_name)])
