<table class="table table-hover table-responsive-md" id="local_tour_bookings-table">
    <thead>
    <tr>
...
@push('after-scripts')
    ...
    <script  type="text/javascript">
        ...
        $(function() {
            var url = "{{ url("/") }}";
            var table= $('#local_tour_bookings-table').DataTable({
                processing: true,
                serverSide: true,
                stateSave: true,
                searching: true,
                ...
                initComplete : function () {
                    table.buttons().container().insertBefore('#local_tour_bookings-table');
                    $("#local_tour_bookings-table").css("width","100%");
                },
                ...
                ajax: '{{ route('localTourBooking.getLocalTourBookings',$localTourPackage->id) }}',
                columns: [
