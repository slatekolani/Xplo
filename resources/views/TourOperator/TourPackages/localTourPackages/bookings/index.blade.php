@extends('layouts.main', ['title' => trans('Local Tour Bookings'), 'header' => trans('Local Tour Bookings')])
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Your discount offer form goes here -->
                    <form>
    ...
    <div class="row" style="overflow-x: scroll">
        ...
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:160%;background-color:rgba(255,255,255,0.85)">
                ...
                @include('TourOperator.TourPackages.localTourPackages.bookings.get_local_bookings')
            </section>
        </div>
...
@push('after-scripts')
    <script>
        $(document).ready(function() {
            $('.offer-discount-option').click(function() {
