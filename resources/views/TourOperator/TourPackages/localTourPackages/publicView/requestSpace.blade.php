<div class="tab-pane fade" id="nav-requestSpace" role="tabpanel" aria-labelledby="nav-requestSpace-tab">
    ...
    <section>
        <div class="row" style="margin: auto">
            <div class="col-md-12">
                @if ($localTourPackage->TotalSpacesRemainedLabel <= 0)
                    <div class="alert alert-danger rounded-lg shadow-sm" role="alert">
                        <i class="fas fa-exclamation-circle me-2"></i>
                        No space is available in this tour. Please find another ones. <a href=""
                            class="alert-link">Click here</a> to find similar safaris.
                    </div>
                @else
                    <div class="alert alert-success rounded-lg shadow-sm" role="alert">
                        <i class="fas fa-check-circle me-2"></i>
                        Space is available! Before booking, use our <a href="#"
                            class="alert-link text-primary">calculator</a> to plan your budget.
                    </div>
                @endif
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('tourist_name', null, ['class' => 'form-control form-control-lg rounded', 'placeholder' => 'Enter your full name', 'required']) }}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::tel('phone_number', null, ['class' => 'form-control form-control-lg rounded', 'placeholder' => '+XXX XXXXXXXXX', 'required']) }}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::email('email_address', null, ['class' => 'form-control form-control-lg rounded', 'placeholder' => 'your@email.com', 'required']) }}
                            ...
                            <div class="section-container mb-4">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        {{ Form::number('total_number_foreigner_adult', null, ['class' => 'form-control rounded', 'placeholder' => 'If none, enter 0', 'required', 'min' => '0', 'id' => 'total_foreign_adults']) }}
                                    </div>
                                    <div class="col-md-6">
                                        {{ Form::label('total_number_foreigner_child', __('Total non-resident children'), ['class' => 'form-label required_asterik']) }}
                                        {{ Form::number('total_number_foreigner_child', null, ['class' => 'form-control rounded', 'placeholder' => 'If none, enter 0', 'required', 'min' => '0', 'id' => 'total_foreign_children']) }}
                                    </div>
                                    <div class="col-md-6">
                                        {{ Form::label('total_number_local_adult', __('Total resident adults'), ['class' => 'form-label required_asterik']) }}
                                        {{ Form::number('total_number_local_adult', null, ['class' => 'form-control rounded', 'placeholder' => 'If none, enter 0', 'required', 'min' => '0', 'id' => 'total_local_adults']) }}
                                    </div>
                                    <div class="col-md-6">
                                        {{ Form::label('total_number_local_child', __('Total resident children'), ['class' => 'form-label required_asterik']) }}
                                        {{ Form::number('total_number_local_child', null, ['class' => 'form-control rounded', 'placeholder' => 'If none, enter 0', 'required', 'min' => '0', 'id' => 'total_local_children']) }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="section-container mb-4">
                                <h5 class="section-title border-bottom pb-2 mb-3">
                                    ...
                                    {{ $localTourPackage->free_of_charge_age }} Years
                                </h5>
                                <div class="form-group">
                                    <div class="alert alert-info mb-3">
                                        <i class="fas fa-info-circle me-2"></i>
                                        Please indicate the total number of children below
                                        {{ $localTourPackage->free_of_charge_age }} years old
                                    </div>
                                    {{ Form::label('total_free_of_charge_children', __('Total children'), ['class' => 'form-label required_asterik']) }}
                                    {{ Form::number('total_free_of_charge_children', null, ['class' => 'form-control rounded', 'placeholder' => 'If none, enter 0', 'required', 'min' => '0']) }}
                            ...
                            <div class="section-container mb-4">
                                ...
                                <div class="form-group">
                                    ...
                                    {{ Form::textarea('message', null, ['class' => 'form-control rounded', 'rows' => 3, 'maxLength' => '100', 'placeholder' => 'Any additional information or requests?', 'required']) }}
                            ...
                            <div class="section-container mb-4">
                                ...
                                <div class="terms-box p-3 bg-light rounded">
                                    <div class="form-check">
                                        {{ Form::checkbox('payment_agreement', '1', false, ['class' => 'form-check-input', 'id' => 'payment_agreement']) }}
                                    ...
                                    <ul class="mt-3 text-muted">
                                        <li>Discount of <span style="color: dodgerblue">{{$localTourPackage->discount_offered}}%</span> are offered when the total number of travelers you have booked for reaches <span style="color: dodgerblue">{{$localTourPackage->number_of_people_for_discount}} people</span> or more.</li>
                                        ...
                                        <li> The starting amount required to proceed with the installment
                                            ...
                                            which is <i
                                                style="color: dodgerblue">{{ $localTourPackage->payment_start_percent }}%</i>
                                            of the discounted amount to be paid before <span style="color: dodgerblue">{{date('jS M Y',strtotime($localTourPackage->payment_start_percent_deadline))}}</span>. This is a non-refundable deposit.
                                        </li>

                                        <li>The deadline for payment for this trip is <i
                                                style="color:dodgerblue">{{ date('jS M Y', strtotime($localTourPackage->payment_deadline)) }}</i>.
                                            Your tour agent will provide additional details regarding payment.</li>
                                            <li>Cancellation fees may apply according to the cancellation policy if you decide to cancel your trip. This will cost you <span style="color: dodgerblue" id="cancellation_fee">...</span>, amounting to <i style="color:dodgerblue">{{ $localTourPackage->cancellation_percent }}%</i> of the total cost. After the cancellation deadline of <i style="color:dodgerblue">{{ date('jS M Y', strtotime($localTourPackage->cancellation_due_date)) }}</i>, no refund will be issued for cancellations. However, early cancellations after booking may result in lower cancellation fees than the standard ones. The final decision is at the discretion of <a href="{{ route('tourOperator.publicView', $localTourPackage->tourOperator->uuid) }}">{{$localTourPackage->tourOperator->company_name}}</a>, based on their requirements.</li>
                                    ...
                                    <div class="form-group">
                                        <div class="alert alert-info mb-3">
                                            ...
                                            <ul>
                                                ...
                                                <li>Partial Payment: Pay in smaller amounts over time until the full balance is cleared. </li>
                                            </ul>
                                ...
                                <div class="terms-box p-3 bg-light rounded">
                                    <div class="form-check">
                                        {{ Form::checkbox('accept_terms', '1', false, ['class' => 'form-check-input', 'id' => 'accept_terms']) }}
                                        {{ Form::label('accept_terms', __('I agree to the following terms:'), ['class' => 'form-check-label fw-bold']) }}
                                    </div>
                                    <ul class="mt-3 text-muted">
                                        <li>I have read and accept the <a
                                                href="{{ route('tourOperator.publicView', $localTourPackage->tourOperator->uuid) }}">{{ $localTourPackage->tourOperator->company_name }}</a>'s
                                            <a href="{{ asset('public/companyTermsAndConditions/' . $localTourPackage->tourOperator->terms_and_conditions) }}"
...
function calculateTotalCost() {
    ...
    // Prices
    const pricePerForeignAdult = parseFloat({{ $localTourPackage->trip_price_adult_foreigner }});
    const pricePerForeignChild = parseFloat({{ $localTourPackage->trip_price_child_foreigner }});
    const pricePerLocalAdult = parseFloat({{ $localTourPackage->trip_price_adult_tanzanian }});
    const pricePerLocalChild = parseFloat({{ $localTourPackage->trip_price_child_tanzanian }});
    const discount = parseFloat({{ $localTourPackage->discount_offered }});
    const startPercent = parseFloat({{ $localTourPackage->payment_start_percent }});
    const cancellationPercent = parseFloat({{ $localTourPackage->cancellation_percent }});
    const minTravellersForDiscount = parseInt({{ $localTourPackage->number_of_people_for_discount }});
