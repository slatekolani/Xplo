        ...
        <div class="card-body">
            <div class="col-md-12 my-4 position-relative">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <h2 class="mb-3" style="font-weight: 700; font-size: 28px; color: #2b3e50;">Safari to
                            {{ $localTourPackage->touristicAttraction->attraction_name }}</h2>
                        ...
                        <div class="text-center mt-4">
                            <a href="{{ route('touristicAttraction.show', $localTourPackage->touristicAttraction->uuid) }}"
                                class="btn btn-outline-primary btn-lg" style="border-radius: 30px; padding: 10px 20px;">
            ...
            <div id="callout" class="callout my-1 p-4"
                style="background-color: #f9f9f9; border-left: 5px solid #007bff; border-radius: 8px;">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 style="font-size: 15px; color: #2b3e50;">Interested in this safari?</h3>
                    <span class="closebtn" onclick="document.getElementById('callout').style.display='none';"
                        style="cursor: pointer; font-size: 20px; color: dodgerblue;">&times;</span>
                </div>
                <div class="callout-container text-center mt-2">
                    <button type="button" class="btn btn-primary btn-lg" data-toggle="modal"
                        data-target="#exampleModalCenter" style="border-radius: 30px; padding: 5px 10px;">
                        Share to Friends
                    </button>
                    ...
                    <div class="tab-pane" id="pills-touristAttraction" role="tabpanel"
                        ...
                        <div class="nav-container" id="stickyNav">
                            ...
                            <ul class="nav nav-tabs flex-nowrap" id="nav-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="nav-Reservation-tab" data-toggle="tab" href="#nav-Reservation"
                                        role="tab">Reservation to be used</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="nav-tourOperator-tab" data-toggle="tab" href="#nav-tourOperator"
                                        role="tab">Tour Operator</a>
                                </li>
                                <li class="nav-item">
