...
@section('content')
    ...
    {{ Form::model($localTourPackage,['enctype="multipart/form-data"','route' => ['localTourPackages.update', $localTourPackage->uuid], 'method'=>'put','autocomplete' => 'off',
                            ...
                            <div class="row">
                                <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <a href="{{asset('public/localSafariBlogImages/'.$localTourPackage->safari_poster)}}">Previous image</a>
                                        ...
                                        <div class="col-xs-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            ...
                                            <table id="collectionStops">
                                                ...
                                                <tr id="collectionStops{{$safariCollectionStation->id}}">
                                                    <td><input type="text" name="collection_stop_name{{$safariCollectionStation->id}}" value="{{$safariCollectionStation->collection_stop_name}}" placeholder="Shoppers" class="form-control" required></td>
                                                    <td><input type="time" name="pick_up_time{{$safariCollectionStation->id}}" value="{{$safariCollectionStation->pick_up_time}}" placeholder="500" class="form-control" required></td>
                                                    <td><input type="number" name="collection_stop_price{{$safariCollectionStation->id}}" value="{{$safariCollectionStation->collection_stop_price}}" placeholder="500" class="form-control" required></td>
                                                    <td><a href="{{route('localTourPackages.deleteCollectionStation',$safariCollectionStation->uuid)}}" class="btn btn-danger btn-sm">Delete</a></td>
                                                </tr>
                                                @empty
                                                ...
                                                @endforelse
                                                <td><a class="btn btn-primary btn-sm" id="addCollectionStop">Add</a></td>
                                                </tbody>
                                            </table>
                                        </div>
                                        <div class="col-xs-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            ...
                                            <table id="activities">
                                                ...
                                                <tr id="activities{{$localTourPackageIncludedActivity->id}}">
                                                    <td><input type="text" name="activity_name{{$localTourPackageIncludedActivity->id}}" value="{{$localTourPackageIncludedActivity->activity_name}}" placeholder="Indoor games" class="form-control" required></td>
                                                    <td><input type="text" name="activity_description{{$localTourPackageIncludedActivity->id}}" value="{{$localTourPackageIncludedActivity->activity_description}}" placeholder="Playing Expedition Games" class="form-control" required></td>
                                                    <td><a href="{{route('localTourPackages.deleteIncludedActivity',$localTourPackageIncludedActivity->uuid)}}" class="btn btn-danger btn-sm">Delete</a></td>
                                                </tr>
                                                @empty
                                                    <tr id="activities">
                                        ...
                                        <div class="col-xs-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            ...
                                            <table id="inclusiveItem">
                                                ...
                                                <tr id="inclusiveItem{{$localTourPackagePriceInclusive->id}}">
                                                    <td><input type="text" name="item{{$localTourPackagePriceInclusive->id}}" value="{{$localTourPackagePriceInclusive->item}}" placeholder="Drinks and Food" class="form-control" required></td>
                                                    <td><a href="{{route('localTourPackages.deletePriceInclusiveItem',$localTourPackagePriceInclusive->uuid)}}" class="btn btn-danger btn-sm">Delete</a></td>
                                                </tr>
                                                @empty
                                                    <tr id="inclusiveItem">
                                                ...
                                                @endforelse
                                                <td><a class="btn btn-primary btn-sm" id="addInclusiveItem">Add</a></td>
                                                </tbody>
                                            </table>
                                        </div>
                                        <div class="col-xs-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            ...
                                            <table id="exclusiveItem">
                                                ...
                                                <tr id="exclusiveItem{{$localTourPackagePriceExclusive->id}}">
                                                    <td><input type="text" name="item{{$localTourPackagePriceExclusive->id}}" value="{{$localTourPackagePriceExclusive->item}}" placeholder="Drinks and Food" class="form-control" required></td>
                                                    <td><a href="{{route('localTourPackages.deletePriceExclusiveItem',$localTourPackagePriceExclusive->uuid)}}" class="btn btn-danger btn-sm">Delete</a></td>
                                                </tr>
                                                @empty
                                                    <tr id="exclusiveItem">
                                                        <td><input type="text" name="item1" placeholder="Drinks and Food" class="form-control" required></td>
                                                ...
                                                @endforelse
                                                <td><a class="btn btn-primary btn-sm" id="addExclusiveItem">Add</a></td>
                                                </tbody>
                                            </table>
                                        </div>
                                        <div class="col-xs-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            ...
                                            <table id="tourRequirements">
                                                ...
                                                <tr id="tourRequirements{{$localTourPackageRequirement->id}}">
                                                    <td><input type="text" name="requirement_name{{$localTourPackageRequirement->id}}" value="{{$localTourPackageRequirement->requirement_name}}" placeholder="Heavy coat" class="form-control" required></td>
                                                    <td><input type="text" name="requirement_description{{$localTourPackageRequirement->id}}" value="{{$localTourPackageRequirement->requirement_description}}" placeholder="It is very cold at this area" class="form-control" required></td>
                                                    <td><a href="{{route('localTourPackages.deleteTripRequirement',$localTourPackageRequirement->uuid)}}" class="btn btn-danger btn-sm">Delete</a></td>
                                                </tr>
                                                @empty
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <div class="form-group">
                                                ...
                                                {{ Form::textarea('discount_offered', $localTourPackage->discount_offered, ['class' => 'form-control', 'style'=>'height:100px','placeholder'=>'If you dont, type no discount offered. If you do, type what groups are to be provided discount eg, family,couple or any category and at what rate','maxLength'=>'300','autocomplete' => 'off', 'id' => 'discount_offered', 'required']) }}
