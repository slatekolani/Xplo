                                        ...
                                        <div class="card h-100 border-primary card-with-gradient">
                                            ...
                                            <div class="card-body" style="position: relative; z-index: 2;">
                                                ...
                                                <h5 class="card-title" style="font-size: 14px;font-weight: bold">A
                                                    {{ \App\Models\tourPackageType\tourPackageType::find($localTourPackage->tour_package_type_name)->tour_package_type_name }}
                                                    special for
                                                    {{ \App\Models\tanzaniaAndWorldEvents\tanzaniaAndWorldEvents::find($localTourPackage->targeted_event)->event_name }}
                                                </h5>
