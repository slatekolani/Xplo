                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('region_description', null, ['class' => 'form-control', 'autocomplete' => 'off','maxLength'=>'100','id' => 'region_description', 'required']) }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::textarea('region_history', null, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'region_history','style'=>'height:100px','maxLength'=>'200', 'required']) }}
